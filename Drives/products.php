...
@media screen and (max-width: 300px) {
  ...
  <div class="site-wrap">
    ...
    <div class="site-section bg-light">
	  ...
	  <a href="../Homepage/home.php"><i class="fa fa-caret-square-o-left" style="font-size:48px" ></i></a>
	  <br>
         ...
         <div class="col-md-12">
           ...
           <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
              ...
              <div class="ml-auto">
                ...
                <button class="btn btn-primary py-2" onclick="myFunction('<?php echo $row['CompanyName']?>');document.getElementById('id02').style.display='block'" style="width:auto" >Apply Job</button>
              </div>
           </div>
...
<div id="id02" class="modal">
	...
	<form class="modal-content" action="apply.php" method="POST">
	<div class="container">
      ...
      <input type="text" placeholder="UserName" name="email" id="email" required style="width:100%">

      <label for="text"><b>Password :</b></label> 
      <input type="password" placeholder="******" name="password" id="password" required style="width:100%">
	  
	  
	   <input type="hidden" id="anupama" name='anu' >
		
     

      <div class="clearfix">
      
        <button type="submit" id="login" name="login" class="signupbtn" >LOGIN</button>
      </div>
    </div>
  </form>
</div>	
...
function myFunction(cn) {
	...
	var cno;
document.cookie = "cno= " + cn;
document.getElementById('anupama').value=cn;
}
</script>
<script>
