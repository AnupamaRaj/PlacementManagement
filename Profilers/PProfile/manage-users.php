...
$sql = "SELECT * FROM basicdetails where Branch like 'CSE' "; 
$rs_result = mysqli_query ($connect,$sql); //run the query

print "<tr><td>CSE<td><tr>";
...
print "<br>";
$sql = "SELECT * FROM basicdetails where Branch like 'ISE' "; 
$rs_result = mysqli_query ($connect,$sql); //run the query

print "<tr><td>ISE<td><tr>";
while ($row = mysqli_fetch_assoc($rs_result)) 
{ 
print "<tr>"; 
print "<td>" . $row['FirstName'] . "</td>"; 
...
print "<br>";
$sql = "SELECT * FROM basicdetails where Branch like 'EEE' "; 
$rs_result = mysqli_query ($connect,$sql); //run the query

print "<tr><td>EEE<td><tr>";
while ($row = mysqli_fetch_assoc($rs_result)) 
{ 
print "<tr>"; 
print "<td>" . $row['FirstName'] . "</td>"; 
...
print "<br>";
$sql = "SELECT * FROM basicdetails where Branch like 'CVE' "; 
$rs_result = mysqli_query ($connect,$sql); //run the query

print "<tr><td>CVE<td><tr>";
while ($row = mysqli_fetch_assoc($rs_result)) 
{ 
print "<tr>"; 
print "<td>" . $row['FirstName'] . "</td>"; 
...
print "<br>";
$sql = "SELECT * FROM basicdetails where Branch like 'ECE' "; 
$rs_result = mysqli_query ($connect,$sql); //run the query

print "<tr><td>ECE<td><tr>";
while ($row = mysqli_fetch_assoc($rs_result)) 
{ 
print "<tr>"; 
print "<td>" . $row['FirstName'] . "</td>"; 
...
print "<br>";
$sql = "SELECT * FROM basicdetails where Branch like 'ME' "; 
$rs_result = mysqli_query ($connect,$sql); //run the query
