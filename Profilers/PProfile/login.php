...
<?php
        ...
        <nav class="templatemo-left-nav">
          <ul>
            ...
            <li><a href="#" class="active"><i class="fa fa-home fa-fw"></i>Placement Drives</a></li>          
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
              ...
              <div class="templatemo-content-widget orangee-bg">
                ...
                <div class="media">
                  ...
                  <div class="media-body">
                    ...
                    <p>View the detailsof Companies Visiting Our Campus</p>  
                  </div>        
                </div>                
              </div> 		
          ...
          <footer class="text-right">
            <p>Copyright &copy; 2019 SIR_MVIT
            | Designed by AAA</a></p>
          </footer>       
        </div>
      </div>
